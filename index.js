...
// Llama a loadCartFromLocal para cargar el carrito al cargar la página
loadCartFromLocal();
...
finalizePurchaseBtn.addEventListener('click', () => {
     // Una vez que la compra se haya completado, limpiar el carrito local
    allProducts = [];
    saveCartToLocal();
    showHTML();

    // Mostrar un mensaje de compra finalizada
